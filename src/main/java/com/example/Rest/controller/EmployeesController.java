...
import com.example.Rest.repository.EmployeesRepository;
...
public class EmployeesController {
	...
	Employee employee=employeeRepository.findById(employeeId).orElseThrow(()->new ResourceNotFoundException("Employee not found this id::"+employeeId));	
